...
import/websites/gr.maharashtra.gov.in/WaterResources:
	cd import/websites/gr.maharashtra.gov.in/ && ln -s $(GR_DIR)/WaterResources .
...
import: check_env import/websites/gr.maharashtra.gov.in/WaterResources .secrets/google.token 
	poetry run python import/src/build_documents.py import/websites/gr.maharashtra.gov.in/WaterResources import/documents
